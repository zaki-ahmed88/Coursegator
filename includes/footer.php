 ...
 <?php
    ...
    //we will use destruct function in Db class instead of using  mysqli_close($conn)
    //destruct function will be excuted automatically after finishing its scope
